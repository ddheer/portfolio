...
- Intuit Assist (GenAI financial assistant), 100M+ customers: pioneered the 0-to-1 GenAI growth and support strategy; led a 40+ person team; CEO unveiled it at the Investor Summit; scaled across 3 business units. Revenue: $11M from launch plus $17M from scaling. Used RAG and Graph-RAG knowledge enrichment, NLP intent work, and AI safety (proactive profanity filtering, bias detection). Results: +15% help resolution, -12% escalation, -15% contact rate, +23% self-help engagement, +43% service efficiency, +11 pts CSAT.
- ML recommendation & personalization engine: $12M monthly recurring revenue, $10M from A/B testing, +20% conversion, +19% targeting/segmentation, +15% search engagement. Built a Data Enrichment platform; early AI testing frameworks for bias.
