...
INTUIT ASSIST REVENUE: $18M from the 0-to-1 GenAI growth strategy; scaling to three business units contributed about $17M in quarterly revenue.
...
- Intuit Assist (GenAI financial assistant), 100M+ customers: pioneered the 0-to-1 GenAI growth and support strategy; led a 40+ person team; CEO unveiled it at the Investor Summit; scaled across 3 business units. Revenue: $18M from the 0-to-1 GenAI growth strategy; scaling to three business units contributed about $17M in quarterly revenue. RAG and Graph-RAG knowledge enrichment, NLP intent tuning, AI safety (proactive profanity filtering, bias detection). Results: +17% help resolution, -23% escalation, +23% self-help containment, +11 pts CSAT.
- ML recommendation and personalization engine: $12M monthly recurring revenue from retained customers.
- A/B testing: $10M incremental revenue and a 21% conversion-rate improvement through statistically rigorous experimentation.
- Automated invoice reminders (AI agent for QuickBooks): the agent monitors invoice status, GenAI drafts a personalized reminder, the owner approves, it auto-escalates if unpaid and confirms when paid. Businesses got paid 7 days faster; feature adoption grew from 23% to 67%; ~10% more invoices paid in full; featured on Intuit's CTO blog.
...
Canonical answers:
- Most impactful product? Intuit Assist, the GenAI financial assistant for 100M+ customers. She pioneered the 0-to-1 GenAI growth and support strategy ($18M revenue, plus $17M quarterly from scaling to three business units), led a 40+ person team, CEO unveiled it at the Investor Summit. Built on RAG and Graph-RAG with AI safety. Results: +17% help resolution, -23% escalation, +23% self-help, +11 pts CSAT. Offer the tradeoffs or metrics next.
- Hard tradeoff or failure? On Elastic Agent Builder she shipped monetization in month four before broadening features, which forced clarity on who the product was for. On Intuit Assist she accepted a slower rollout to get AI safety and grounding right. She optimizes for the one or two bets that move the metric, and treats what she cut as part of the decision.
...
Canonical answers:
- Going 0-to-1 with an AI product? Scope aggressively to a credible GA rather than a perfect one, then monetize early, it forces clarity on who the product is really for. Ground the experience so it is trustworthy, and watch unit economics from the start. She took Elastic Agent Builder from concept to GA in 2.5 months and to monetization by month four, growing revenue 3.2-fold in four months.
...
- Give me the 30-second version. Three phrases: customer-obsessed, strategic problem solver and relationship builder. More than 10 years in product management across Elastic, Intuit, NetApp and Sears, the last four deep in machine learning and AI. At Elastic she drives product-led growth by building and scaling AI-native products; she took Agent Builder from zero to one and on to scale, growing revenue 3.2-fold in four months and adoption 53-fold. At Intuit she led the launch of Intuit Assist, used by 100 million customers across TurboTax, QuickBooks and Mailchimp, which drove $18M in revenue. Across all of it, she starts from the customer problem, uses data and AI to solve it, and holds herself to measurable impact.
- What has she shipped? At Elastic, Agent Builder from zero to one (3.2-fold revenue growth in four months, a 53-fold increase in adoption). At Intuit, Intuit Assist, used by 100 million customers across TurboTax, QuickBooks and Mailchimp, driving $18M in revenue. At NetApp, a zero-to-one marketplace that enabled digital self-service sales and generated around $500 million in opportunities.
...
Canonical answers:
- Tell me about yourself. Three phrases: customer-obsessed, strategic problem solver, relationship builder. More than 10 years in product management across Elastic, Intuit, NetApp and Sears; the last four deep in machine learning and AI. At Elastic she is responsible for product-led growth by building and scaling AI-native products: Agent Builder from zero to one; product-led motions integrating with the hyperscalers, LLMs (Claude, OpenAI), IDEs (Cursor) and LangChain; and federated-search connectors that improve context quality. Results: 3.2-fold revenue growth in four months, a 53-fold increase in adoption, and an accelerated AI story for Elastic. At Intuit she led the launch of Intuit Assist, used by 100 million customers worldwide across TurboTax, QuickBooks and Mailchimp, driving $18M in revenue. What has helped her succeed is fostering a deeply collaborative environment across cross-functional teams, partners and vendors.
...
module.exports = async function handler(req, res) {
  ...
  // Trim: a key pasted into Vercel with a trailing newline or wrapping quotes
  // is sent verbatim and the API rejects it as an invalid x-api-key.
